...
// this version of tsplot graphs event dates and log y-axis up to 10,000 for deaths

	// define program
	cap program drop tsplot_logs_deaths
	program define tsplot_logs_deaths
	syntax varlist
	...
	ylab(4.6 "100" 6.9 "1,000" 9.2 "10,000")
	macro drop _line
	end
