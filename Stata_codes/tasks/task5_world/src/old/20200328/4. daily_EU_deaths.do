...
// table with ndeaths for EU28	
	sort rank
	export delimited rank country cum_deaths ///
	using "./output/rank_deaths_EU28_top${top_EU}.csv", replace delim(",")
...
use "$task1/output/covid_cases_bycountry", clear
	...
	macro drop _line 
	graph export "./output/cumdeaths_byday_EU28_top${top_EU}.svg", replace 
...
// graph
	...
	macro drop _line
	graph export "./output/cumdeaths_post10_EU28_top${top_EU}.svg", replace 
...
// graph
	...
	macro drop _line
	graph export "./output/cumdeaths_perMln_post10_EU28_top${top_EU}.svg", replace 
