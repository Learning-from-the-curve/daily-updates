...
// This file constructs graphs, tables and maps for
// number of new cases, globally.
 
*-----------------------------------
* 1. Table, top x countries, by date
*-----------------------------------
...
// table: top x new cases today
	...
	"./output/new_cases_global_bydate.csv", replace delim(",")
		
*-----------------------------------		
* 2. Graph, top x countries, by date		
*-----------------------------------
use "$task1/output/covid_cases_bycountry", clear
...
use "$task1/output/covid_cases_bycountry", clear
	...
	title("New cases", size(medium)) ytitle("Number of cases") 
	macro drop _line
	graph export "./output/new_cases_global_bydate.svg", replace 

*--------------------------------------------
* 3. Table, top x countries, since 100th case
*--------------------------------------------
use "$task1/output/covid_cases_bycountry", clear
//sync events
...
// graph
	...
	macro drop _line
	graph export "./output/new_cases_global_post100.svg", replace 
