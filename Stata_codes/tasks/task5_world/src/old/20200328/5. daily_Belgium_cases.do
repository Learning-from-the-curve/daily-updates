...
// table with ncases for Belgium	
	export delimited country cum_cases ///
	using "./output/rank_cases_Belgium.csv", replace delim(",")
...
foreach country in `countrylist' {
	...
	macro drop _line
	graph export "./output/cumcases_byday_Belgium.svg", replace 
...
// graph
	...
	macro drop _line
	graph export "./output/cumcases_post100_Belgium.svg", replace 
