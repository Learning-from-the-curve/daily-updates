...
use "$task1/output/covid_cases_bycountry", clear
	...
	macro drop _line
	graph export "./output/EU28_top${top_EU}_cumdeaths_bydate.svg", replace 
...
// graph (logs)
	...
	macro drop _line
	graph export "./output/EU28_top${top_EU}_lncumdeaths_bydate.svg", replace 
...
// graph (logs)
	...
	macro drop _line
	graph export "./output/EU28_top${top_EU}_lncumdeaths_post10.svg", replace 
...
// graph (logs)
	...
	ylab(4.6 "100" 6.9 "1,000" 9.2 "10,000" 11.5 "100,000")
	macro drop _line
	graph export "./output/EU28_top${top_EU}_lncumdeathsperMln_post10perMln.svg", replace 
...
// graph
	...
	macro drop _line
	graph export "./output/EU28_top${top_EU}_ma3deaths_post10.svg", replace 
...
// graph (levels)
	...
	macro drop _line
	graph export "./output/EU28_top${top_EU}_sharemortality_post10.svg", replace 
...
// graph (levels)
	...
	macro drop _line
	graph export "./output/EU28_top${top_EU}_CFR_post10.svg", replace 
