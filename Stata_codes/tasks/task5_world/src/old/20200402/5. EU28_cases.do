...
// numbers in report: top 3 with numbers
	gsort -cum_cases
	forvalues i = 1/3 {
		global n`i'_country_cumcases_EU = "country[`i']"
		global n`i'_ncumcases_EU = cum_cases[`i']
	}
...
use "$task1/output/covid_cases_bycountry", clear
	...
	macro drop _line
	graph export "./output/EU28_top${top_world}_cumcases_bydate.svg", replace 
...
// graph (logs)
	...
	macro drop _line
	graph export "./output/EU28_top${top_world}_lncumcases_bydate.svg", replace 
...
// graph (logs)
	...
	macro drop _line
	graph export "./output/EU28_top${top_world}_lncumcases_post100.svg", replace 
...
// graph (logs)
	...
	macro drop _line
	graph export "./output/EU28_top${top_world}_lncumcasesperMln_post100perMln.svg", replace 	
...
// graph
	...
	macro drop _line
	graph export "./output/EU28_top${top_world}_ma3cases_post100.svg", replace 
...
// share infected by date
	gen share_infected = cum_cases/population*100	
...
// graph (levels)
	...
	macro drop _line
	graph export "./output/EU28_top${top_world}_shareinfected_post100.svg", replace 			
