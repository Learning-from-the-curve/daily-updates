...
use "$task1/output/covid_cases_bycountry", clear
	keep if EU28 == 1
	*drop if date < 21946					// drop before Feb 1
	
// graph
	tsplot_date cum_deaths cum_deaths
	graph export "./output/EU_cumdeaths_bydate.svg", replace 
...
// graph
	...
	graph export "./output/EU_lncumdeaths_post10.svg", replace 
...
// graph	
	...
	graph export "./output/EU_growthdeaths_post10.svg", replace		
...
// graph	
	...
	graph export "./output/EU_sh_cumdeaths.svg", replace 
